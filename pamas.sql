...
CREATE TABLE IF NOT EXISTS `pamas`.`vehicle_model` (
  ...
  INDEX `fk_vehicle_model_type_idx` (`typology` ASC) INVISIBLE,
  CONSTRAINT `fk_vehicle_model_type`
    FOREIGN KEY (`typology`)
    REFERENCES `pamas`.`vehicle_type` (`value`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pamas`.`vehicle` (
  ...
  INDEX `fk_vehicle_vehicle_type1_idx` (`typology` ASC) VISIBLE,
...
START TRANSACTION;
USE `pamas`;
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Autobus', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Autocarro', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Autoveicolo', 1, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Camper', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Furgone', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Roulotte', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Motociclo', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Motoveicolo', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`value`, `default`, `subprice`, `updated`, `created`) VALUES ('Altro', 0, 0, DEFAULT, DEFAULT);
