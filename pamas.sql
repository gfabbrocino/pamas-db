...
START TRANSACTION;
USE `pamas`;
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (1, NULL, 'Autobus', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (2, NULL, 'Autocarro', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (3, NULL, 'Autoveicolo', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (4, NULL, 'Camper', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (5, NULL, 'Furgone', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (6, NULL, 'Roulotte', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (7, NULL, 'Motociclo', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (8, NULL, 'Motoveicolo', 0);
INSERT INTO `pamas`.`vehicle_type` (`id_vehicle_type`, `id_rate`, `name`, `subprice`) VALUES (9, NULL, 'Altro', 0);
