...
CREATE TABLE IF NOT EXISTS `pamas`.`vehicle_type` (
  `id_typology` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `value` VARCHAR(50) NOT NULL,
  `default` TINYINT(1) NOT NULL DEFAULT 0,
  `subprice` DECIMAL(10,2) NULL,
  `updated` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `created` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_typology`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `pamas`.`vehicle_model` (
  ...
  INDEX `fk_vehicle_model_vehicle_type1_idx` (`id_typology` ASC) VISIBLE,
  CONSTRAINT `fk_vehicle_model_vehicle_type1`
    FOREIGN KEY (`id_typology`)
    REFERENCES `pamas`.`vehicle_type` (`id_typology`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- Table `pamas`.`holiday`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `pamas`.`holiday` ;

CREATE TABLE IF NOT EXISTS `pamas`.`holiday` (
...
START TRANSACTION;
USE `pamas`;
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (1, 'Autobus', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (2, 'Autocarro', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (3, 'Autoveicolo', 1, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (4, 'Camper', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (5, 'Furgone', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (6, 'Roulotte', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (7, 'Motociclo', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (8, 'Motoveicolo', 0, 0, DEFAULT, DEFAULT);
INSERT INTO `pamas`.`vehicle_type` (`id_typology`, `value`, `default`, `subprice`, `updated`, `created`) VALUES (9, 'Altro', 0, 0, DEFAULT, DEFAULT);

COMMIT;


-- -----------------------------------------------------
-- Data for table `pamas`.`holiday`
-- -----------------------------------------------------
START TRANSACTION;
USE `pamas`;
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (1, 'Capodano', 1, 1);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (2, 'Epifania', 6, 1);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (3, 'Lunedì in Albis', 23, 4);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (4, 'Festa dei Lavoratori', 1, 5);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (5, 'Liberazione', 25, 4);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (6, 'Tutti i Santi', 2, 11);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (7, 'Immacolata Concezzione', 8, 12);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (8, 'Santo Natale', 25, 12);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (9, 'Santo Stefano', 26, 12);
INSERT INTO `pamas`.`holiday` (`id_holiday`, `name`, `day`, `mounth`) VALUES (10, 'Santo Patrono', 22, 10);
